...
Зайдя в полученный ZIP-файл и открыв UserInfo.exe я увидел 3 файла но информации по факту там нет. Полазив по остальным папкам я тоже ничего не нашёл. Пришлось воспользовать подсказкой. Говориться что этот файл UserInfo.exe нужно запустить на самом целевом пк. 
